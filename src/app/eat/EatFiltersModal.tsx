...
export default function EatFiltersModal({
  open,
  filters,
  cuisineOptions,
  matchCount,
      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            >
              {sectionTitle(<DollarSign size={16} color="#2563eb" />, "Max Cost")}
              <div
                style={{
                  marginTop: 12,
                  display: "flex",
                  ...
                  return (
                    <button
                      ...
                      onClick={() =>
                        onChange({
                          ...filters,
                          minOverall: filters.minOverall === value ? null : value,
                        })
                      }
                      style={{
                        border: "none",
